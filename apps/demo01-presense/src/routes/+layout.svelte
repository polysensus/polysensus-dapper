<script lang="ts">
	...
	import { ChainPresence } from '@polysensus-dapper/chainpresence';

	import { all } from '@polysensus-dapper/chainpresence';
	// contexts
			...
			<svelte:fragment slot="lead">
				...
				<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">
					{#if homeRef && homeText && homeTarget}
						<a href={$homeRef} target={$homeTarget}
							><strong class="text-xl uppercase">{$homeText}</strong></a
						>
					{/if}
				</span>
			</svelte:fragment>
